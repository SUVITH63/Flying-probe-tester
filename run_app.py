#!/usr/bin/env python3
"""
OpenFPT Standalone Cross-Platform Application Launcher
...
def main():
    port = 8000
    print("=" * 65)
    print("   OpenFPT — Automated Flying Probe PCB Tester Web App")
    print("=" * 65)
    print(f"[*] Starting OpenFPT Web App Server on http://localhost:{port}...")
    ...
    # Run native zero-dependency HTTP server
    run_server(port)
